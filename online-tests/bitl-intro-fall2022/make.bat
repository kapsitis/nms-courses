...
if [%2] == [] (
    ...
    if [%2] == [solutions] (
        ...
        ren fysfall2022pre-assessment.pdf fysfall2022pre-assessment-solutions.pdf
        xcopy fysfall2022pre-assessment-solutions.pdf ..\.. /Y
		cd ..\..
    ) else (
        echo.Building questions
		%SPHINXBUILD% -M %1 %SOURCEDIR% %BUILDDIR% %SPHINXOPTS% %O%
	    cd _build\latex
        xcopy fysfall2022pre-assessment.pdf ..\.. /Y
		cd ..\..
	)
)
goto end
