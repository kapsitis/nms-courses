...
import re
with open ('_build\\latex\\fysfall2021pre-assessment.tex', 'r', encoding='utf-8') as f:
    content = f.read()
...
with open ('_build\\latex\\fysfall2021pre-assessment.tex', 'w', encoding='utf-8') as fout:
