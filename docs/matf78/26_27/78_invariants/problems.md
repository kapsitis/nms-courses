...
## 1.daļa. Nemainīgas izteiksmes, summas un atlikumi
...
* *Izpēte*: Par cik mainās **visu** monētu kopskaits vienā gājienā?
...
* *Izpēte*: Par cik pieaug gabalu skaits, ja vienu gabalu griež $3$ daļās
(vai $5$ daļās)?
...
* *Izpēte*: Saskaiti abu gājienu **kopējo** iznākumu: $-5+9$ un $-10+2$.
...
$+$ vai $-$) summa ir $0$. Kas ir kopīgs visiem skaitļiem $6, 10, 14, 18$?
...
* *Izpēte*: Izvēlieties **vienu** skaitli (visu bumbiņu skaitu, balto/melno 
bumbiņu skaitu - vai nu kopā, vai kādā no kastēm), uzzīmējiet tabulu 
ar gājienu veidiem.
...
* *Izpēte*: Cik melnas rūtiņas ir šaha veidā nokrāsotā $10 \times 9$ taisnstūrī?
Cik melnas rūtiņas noklāj katra no trim figūrām (jebkurā veidā pagriezta)?
...
pamīšus melna–balta. Cik **baltu** rūtiņu varde ir noteikti apmeklējusi? Cik
baltu rūtiņu var palikt neapmeklētas? `#AuxiliaryColoring`
