...
import re
with open ('_build/latex/lossless04-burrows-wheeler.tex', 'r', encoding='utf-8') as f:
    content = f.read()
...
with open ('_build/latex/lossless04-burrows-wheeler.tex', 'w', encoding='utf-8') as fout:
