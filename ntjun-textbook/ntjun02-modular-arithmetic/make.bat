...
if [%2] == [] (
    ...
    if [%2] == [solutions] (
	    ...
	    cd _build\latex
	    xelatex ntjun02-modular-arithmetic
        ren ntjun02-modular-arithmetic.pdf ntjun02-modular-arithmetic-solutions.pdf
        xcopy ntjun02-modular-arithmetic-solutions.pdf ..\.. /Y
		cd ..\..
    ) else (
        ...
        xcopy ntjun02-modular-arithmetic.pdf ..\.. /Y
		cd ..\..		
	)
)
goto end
