...
if [%2] == [] (
    ...
    if [%2] == [solutions] (
        ...
        python replace.py
	    cd _build\latex
	    pdflatex ntjun04-multiplicative
        ren ntjun04-multiplicative.pdf ntjun04-multiplicative-solutions.pdf
        xcopy ntjun04-multiplicative-solutions.pdf ..\.. /Y
		cd ..\..
    ) else (
        ...
        xcopy ntjun04-multiplicative.pdf ..\.. /Y
		cd ..\..		
	)
)
goto end
