...
if [%2] == [] (
    ...
    if [%2] == [solutions] (
        ...
        python replace.py
	    cd _build\latex
	    pdflatex ntjun05-valuations
        ren ntjun05-valuations.pdf ntjun05-valuations-solutions.pdf
        xcopy ntjun05-valuations-solutions.pdf ..\.. /Y
		cd ..\..
    ) else (
        ...
        xcopy ntjun05-valuations.pdf ..\.. /Y
		cd ..\..		
	)
)
goto end
