...
if [%2] == [] (
    ...
    if [%2] == [solutions] (
	    ...
	    cd _build\latex
	    xelatex ntjun07-quadratic
        ren ntjun07-quadratic.pdf ntjun07-quadratic-solutions.pdf
        xcopy ntjun07-quadratic-solutions.pdf ..\.. /Y
		cd ..\..
    ) else (
