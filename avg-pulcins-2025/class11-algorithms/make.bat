...
if [%2] == [] (
    ...
    if [%2] == [solutions] (
        ...
        python replace.py
	    cd _build\latex
	    pdflatex class11-algorithms
        ren class11-algorithms.pdf class11-algorithms-solutions.pdf
        xcopy class11-algorithms-solutions.pdf ..\.. /Y
		cd ..\..
    ) else (
        ...
        xcopy class11-algorithms.pdf ..\.. /Y
		cd ..\..		
	)
)
goto end
