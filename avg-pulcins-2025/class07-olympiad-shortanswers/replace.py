...
with open ('_build/latex/class07-olympiad-shortanswers.tex', 'r', encoding='utf-8') as f:
    content = f.read()
...
with open ('_build/latex/class07-olympiad-shortanswers.tex', 'w', encoding='utf-8') as fout:
    fout.write(content)
    fout.close
