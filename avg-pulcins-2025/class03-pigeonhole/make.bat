...
if [%2] == [] (
    ...
    if [%2] == [solutions] (
        ...
        python replace.py
	    cd _build\latex
	    pdflatex class03-pigeonhole
        ren class03-pigeonhole.pdf class03-pigeonhole-solutions.pdf
        xcopy class03-pigeonhole-solutions.pdf ..\.. /Y
		cd ..\..
    ) else (
        ...
        xcopy class03-pigeonhole.pdf ..\.. /Y
		cd ..\..		
	)
)
goto end
