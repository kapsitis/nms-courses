...
if [%2] == [] (
    ...
    if [%2] == [solutions] (
        ...
        python replace.py
	    cd _build\latex
	    pdflatex class10-sequences
        ren class10-sequences.pdf class10-sequences-solutions.pdf
        xcopy class10-sequences-solutions.pdf ..\.. /Y
		cd ..\..
    ) else (
