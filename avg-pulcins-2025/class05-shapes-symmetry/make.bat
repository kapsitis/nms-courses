...
if [%2] == [] (
    ...
    if [%2] == [solutions] (
        ...
        python replace.py
	    cd _build\latex
	    pdflatex class05-shapes-symmetry
        ren class05-shapes-symmetry.pdf class05-shapes-symmetry-solutions.pdf
        xcopy class05-shapes-symmetry-solutions.pdf ..\.. /Y
		cd ..\..
    ) else (
        ...
        xcopy class05-shapes-symmetry.pdf ..\.. /Y
		cd ..\..		
	)
)
goto end
