...
if [%2] == [] (
    ...
    if [%2] == [solutions] (
        ...
        python replace.py
	    cd _build\latex
	    pdflatex class01-expressions
        ren class01-expressions.pdf class01-expressions-solutions.pdf
        xcopy class01-expressions-solutions.pdf ..\.. /Y
		cd ..\..
    ) else (
        ...
        xcopy class01-expressions.pdf ..\.. /Y
		cd ..\..		
	)
)
goto end
