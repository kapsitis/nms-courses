...
if [%2] == [] (
    ...
    if [%2] == [solutions] (
        ...
        python replace.py
	    cd _build\latex
	    pdflatex class04-decimal-notation
        ren class04-decimal-notation.pdf class04-decimal-notation-solutions.pdf
        xcopy class04-decimal-notation-solutions.pdf ..\.. /Y
		cd ..\..
    ) else (
        ...
        xcopy class04-decimal-notation.pdf ..\.. /Y
		cd ..\..		
	)
)
goto end
