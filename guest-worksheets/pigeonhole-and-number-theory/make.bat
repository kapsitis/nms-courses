...
if [%2] == [] (
    ...
    if [%2] == [solutions] (
        ...
        python replace.py
	    cd _build\latex
	    pdflatex pigeonhole-and-number-theory
        ren cpigeonhole-and-number-theory.pdf pigeonhole-and-number-theory-solutions.pdf
        xcopy pigeonhole-and-number-theory-solutions.pdf ..\.. /Y
		cd ..\..
    ) else (
        ...
        xcopy pigeonhole-and-number-theory.pdf ..\.. /Y
		cd ..\..		
	)
)
goto end
