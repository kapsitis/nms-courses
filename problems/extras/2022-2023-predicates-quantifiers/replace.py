...
import re
with open ('_build/latex/2022-2023-predicates-quantifiers.tex', 'r', encoding='utf-8') as f:
    content = f.read()
...
with open ('_build/latex/2022-2023-predicates-quantifiers.tex', 'w', encoding='utf-8') as fout:
