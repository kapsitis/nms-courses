...
if [%2] == [] (
    ...
    if [%2] == [solutions] (
        ...
        python replace.py
	    cd _build\latex
	    pdflatex class01A-math-creativity
        ren class01A-math-creativity.pdf class01A-math-creativity-solutions.pdf
        xcopy class01A-math-creativity-solutions.pdf ..\.. /Y
		cd ..\..
    ) else (
        ...
        xcopy class01A-math-creativity.pdf ..\.. /Y
		cd ..\..		
	)
)
goto end
